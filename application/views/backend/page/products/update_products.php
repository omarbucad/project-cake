                ...
                <div class="container ">
                    <div class="row no-margin-bottom">
                        <div class="col-xs-12 col-lg-8 no-margin-bottom text-left">
                            <a href="javascript:void(0);" data-href="<?php echo site_url('app/products/delete_product/'.$result->product_id);?>" class="btn btn-danger btn-sm btn-delete-product">Delete Product</a>
                        </div>
                        <div class="col-xs-12 col-lg-4 text-right no-margin-bottom">
                            <a href="<?php echo site_url("app/products"); ?>" class="btn btn-primary">Cancel</a>
                    ...
                    <div class="card margin-bottom">
                        ...
                        <div class="card-body">
                            <dl class="dl-horizontal text-left">
                                ...
                                <dd>
                                    <div class="form-group">
                                        <input type="number" step="0.01" name="product_price" class="form-control" placeholder="0.00" value="<?php echo $result->price_raw; ?>">
                                    </div>
                                </dd>
                                <dt>Position</dt>
                                <dd>
